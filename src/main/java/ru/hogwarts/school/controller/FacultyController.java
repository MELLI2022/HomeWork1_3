...
public class FacultyController {
    ...
    @GetMapping("/filter")
    public ResponseEntity<List<Faculty>> findByColorFaculty(@RequestParam(required = false) String color){
           return ResponseEntity.ok(facultyService.findByColorFaculty(color));
    }
